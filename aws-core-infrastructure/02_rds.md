...
踏み台から内部LinuxへSSH<br>
```
ssh -i my-ec2-key.pem ec2-user@<内部サーバーのプライベートIP>
```
インターネットへ出られるか確認<br>
```
...
エンドポイント：mysql-db-01..xxxxxxxxxxxx..ap-southeast-2.rds.amazonaws.com -P 3306
RDS接続　mysql -h mysql-db-01..xxxxxxxxxxxx..ap-southeast-2.rds.amazonaws.com -P 3306 -u admin -p
```
実行するとパスワードを聞かれる。
Enter password:
